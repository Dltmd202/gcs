    ...
    public MAVLinkMessage unpack() {
        switch (msgid) {
                ...
                return  new msg_led_control(this);
                        case msg_piksi_obs.MAVLINK_MSG_ID_PIKSI_OBS:
                return  new msg_piksi_obs(this);
                        case msg_piksi_base_pos_ecef.MAVLINK_MSG_ID_PIKSI_BASE_POS_ECEF:
                return  new msg_piksi_base_pos_ecef(this);
                        case msg_target_offboard.MAVLINK_MSG_ID_TARGET_OFFBOARD:
                return  new msg_target_offboard(this);
                ...
                return  new msg_scenario_cmd(this);
                        case msg_piksi_glo_biases.MAVLINK_MSG_ID_PIKSI_GLO_BIASES:
                return  new msg_piksi_glo_biases(this);
                        case msg_piksi_pos_llh.MAVLINK_MSG_ID_PIKSI_POS_LLH:
                return  new msg_piksi_pos_llh(this);
