 ...
 * scenario_cmd
 */
public class msg_scenario_cmd_start extends MAVLinkMessage {

    public static final int MAVLINK_MSG_ID_SCENARIO_CMD = 185;
     ...
     */
    public msg_scenario_cmd_start(int param1, float param2, float param3, long param4, short target_system, short cmd, short[] param5) {
        this.msgid = MAVLINK_MSG_ID_SCENARIO_CMD;
     ...
     */
    public msg_scenario_cmd_start(int param1, float param2, float param3, long param4, short target_system, short cmd, short[] param5, int sysid, int compid, boolean isMavlink2) {
        this.msgid = MAVLINK_MSG_ID_SCENARIO_CMD;
        this.sysid = sysid;
        this.compid = compid;
     ...
     *
     */
    public msg_scenario_cmd_start(MAVLinkPacket mavLinkPacket) {
        this.msgid = MAVLINK_MSG_ID_SCENARIO_CMD;
