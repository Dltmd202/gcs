package com.gcs.monolith.web.agent.dto;

import com.gcs.domain.agent.Agent;
import com.gcs.domain.agent.dto.AgentDto;
import com.gcs.monolith.web.agent.coordinate.llh.dto.LlhResponse;
import com.gcs.monolith.web.agent.coordinate.ned.dto.NedResponse;
import com.gcs.monolith.web.agent.rotation.RotationResponse;
import com.gcs.monolith.web.agent.velocity.dto.VelocityResponse;
